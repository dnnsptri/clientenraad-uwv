            ...
            <div className="pt-6 space-y-4">
              ...
              <div className="text-sm text-neutral-600">
                ...
                <div className="flex justify-center space-x-4 mt-2">
                  <Link href="/foreword" className="text-primary-500 hover:text-primary-600 underline">
                    Voorwoord
                  </Link>
                  <Link href="/attachments" className="text-primary-500 hover:text-primary-600 underline">
                    Bijlagen
                  </Link>
                </div>
              </div>
