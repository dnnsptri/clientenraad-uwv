      ...
      <div className="relative -mt-24 z-10">
        <div className="container">
          <div className="relative mx-auto max-w-5xl">
            ...
            <div className="rounded-sm p-8 lg:p-20 text-left min-h-[260px] lg:h-[360px] flex flex-col justify-center" style={{ backgroundColor: 'var(--blue)', boxShadow: 'none', color: 'var(--white)' }}>
